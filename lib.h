...
#define TERM1_ATTRIB    0xf
#define TERM2_ATTRIB    0x4
#define TERM3_ATTRIB    0x2
...
/* Function declared to be used in Terminal Driver*/
extern void clear_screen();
extern void put_cursor(int row, int col);
extern void scroll_up();
extern void scroll_up1();
extern void update_cursor();
extern void erase_line(signed line);
